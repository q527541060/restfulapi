...
CREATE TABLE if not exists `db_spm01`.`s_realTimeSituation`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_component`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_defaultSetting`  (
...
/*INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 1, 'boardMachineTimeLimit', '5', '2020-07-24 17:09:50', '看板实时刷新(小时单位)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=1);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 2, 'FPY', '1', '2020-07-17 18:19:31', '看板是否需要FPY图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=2);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 3, 'CPK', '1', '2020-07-16 17:40:35', '看板是否需要CPK图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=3);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 4, 'Product', '1', '2020-07-17 18:19:25', '看板是否需要Product图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=4);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 5, 'DefaultTop5', '1', '2020-07-16 17:42:31', '看板是否需要top5图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=5);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 6, 'defaultType', '1;2;3;4;5', '2020-07-24 17:10:15', 'top5设置'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=6);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 7, 'boardMachineRefreshTime', '4', '2020-07-17 18:20:45', '看板实时刷新间隔(秒单位)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=7);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 8, 'autoDelete', '0', '2020-07-17 10:20:53', '自动删除'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=8);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 9, 'autoDeleteDays', '35', '2020-07-24 17:10:04', '保存数据天数'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=9);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 10, 'standCPK', '1', '2020-07-24 17:10:04', 'CPK设置标准值'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=10);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 11, 'Frequency-start', '8', '2020-07-24 17:10:04', '班次设置值(例如早上八点:8   24小时制)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=11);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 12, 'autoDelete-MaxDays', '365', '2020-07-24 17:10:04', '自动删除最大上限设置天数(一般不设置,如果需要删除天数大于365天请修改天数 例如500天 500)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=12);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 13, 'hChartColor', '0', '2020-07-24 17:10:04', '选择chart柱形图图表主题皮肤'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=13);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 14, 'backgroundColor', '2', '2020-07-24 17:10:04', '选择spc系统背景皮肤'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=14);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 15, 'passPcbYeild', '85', '2020-07-24 17:10:04', '看板直通率标准设定值 例如85% 85'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=15);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 16, 'boardView-chartMove', '0', '2020-07-24 17:10:04', '看板动画渲染开关'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=16);
INSERT INTO `db_spm01`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 17, 'showPad2DImageMode', '0', '2020-07-24 17:10:04', '选择查看缺陷图片方式'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm01`.s_defaultSetting where id=17);
*/
-- ----------------------------
-- Table structure for s_errorcode
-- ----------------------------

CREATE TABLE IF NOT EXISTS `db_spm01`.`s_errorcode`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_job`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_line`  (
                                                  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_1`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_2` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_3` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_4` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_5` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_6` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_7` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_8` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_9` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_10` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_11` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_12` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_13` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_14` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_15` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_16` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_17` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_18` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_19` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_20` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_21` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_22` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_23` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_24` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_25` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_26` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_27` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_28` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_29` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_30` LIKE `db_spm01`.`s_pad_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pad_31` LIKE `db_spm01`.`s_pad_1`;

-- ----------------------------
-- Table structure for s_pcb
-- ----------------------------

CREATE TABLE IF NOT EXISTS `db_spm01`.`s_pcb`  (
                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                 `pcbIdLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_status`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_user`  (
                                                  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_realTimeAutoRefresh`  (
                                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                                 `LineNo` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                                 `PCBIDs` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`s_realTimeConfig`  (
                                                            `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                            `JobName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                            `LineNo` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                            `LaneNo` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_line`  (
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_job`  (
                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                 `jobName` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                 `jobVersion` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                 `lineNo` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_status`  (
                                                    `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  #CONSTRAINT `FK_Reference_astatus_lineNo_aline` FOREIGN KEY (`lineNo`) REFERENCES `db_spm01`.`a_line` (`LineNo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_pcb`  (
                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                 `lineNo` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                 `jobName` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                 `aoiMode` int(1) NULL DEFAULT NULL,
  ...
  #CONSTRAINT `FK_Reference_apcb_jobName_ajob` FOREIGN KEY (`jobName`) REFERENCES `db_spm01`.`a_job` (`jobName`) ON DELETE CASCADE ON UPDATE CASCADE,
  #CONSTRAINT `FK_Reference__apcb_lineNo_aline` FOREIGN KEY (`lineNo`) REFERENCES `db_spm01`.`a_line` (`LineNo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_fov`  (
                                                 `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  #CONSTRAINT `FK_Reference_afov_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm01`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_1`  (
                                                         `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                         `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                         `aoiMode` int(1) NULL DEFAULT NULL,
  ...
  #CONSTRAINT `FK_Reference_acomponent1_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm01`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_2` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_3` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_4` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_5` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_6` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_7` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_8` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_9` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_10` LIKE `db_spm01`.`a_component_1`;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_11` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_12` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_13` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_14` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_15` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_16` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_17` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_18` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_19` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_20` LIKE `db_spm01`.`a_component_1`;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_21` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_22` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_23` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_24` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_25` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_26` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_27` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_28` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_29` LIKE `db_spm01`.`a_component_1`;
CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_30` LIKE `db_spm01`.`a_component_1`;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_component_31` LIKE `db_spm01`.`a_component_1`;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_window`  (
                                                    `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  #CONSTRAINT `FK_Reference_awindow_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm01`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

CREATE TABLE IF NOT EXISTS `db_spm01`.`a_defaultType`  (
                                                         `create_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
