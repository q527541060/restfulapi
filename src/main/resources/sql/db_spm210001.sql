...
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark,create_time) SELECT 8, 'autoDelete', '0', '2020-07-17 10:20:53', '自动删除','21000101'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=8);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark,create_time) SELECT 9, 'autoDeleteDays', '35', '2020-07-24 17:10:04', '保存数据天数','21000101'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=9);
